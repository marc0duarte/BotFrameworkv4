    ...
    async onTurn(turnContext) {
        ...
        if (turnContext.activity.type === ActivityTypes.Message) {
            ...
            if(topIntent.intent === 'Saludo'){
                ...
                const card = CardFactory.heroCard('Carta de Saludo', undefined,
            ...
            await turnContext.sendActivity('Bienvenido al Asistente Virtual. Realiza las preguntas que tengas y yo te daré la repsuesta');
        } else if (turnContext.activity.type !== ActivityTypes.ConversationUpdate) {
